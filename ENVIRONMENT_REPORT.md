...
## 2. Diagnóstico completo do Flutter/Dart Toolchain

$ flutter doctor -v
[√] Flutter (Channel stable, 3.47.2, on Microsoft Windows [versÆo 10.0.26200.9168], locale pt-BR) [421ms]
...
[√] Windows Version (11 Pro 64-bit, 25H2, 2009) [1.568ms]
...
[√] Chrome - develop for the web [151ms]
    • Chrome at C:\Program Files\Google\Chrome\Application\chrome.exe

[√] Visual Studio - develop Windows apps (Visual Studio Community 2022 17.14.3) [149ms]
    • Visual Studio at C:\Program Files\Microsoft Visual Studio\2022\Community
    • Visual Studio Community 2022 version 17.14.36127.28
    • Windows 10 SDK version 10.0.26100.0

[√] Connected device (3 available) [324ms]
    • Windows (desktop) • windows • windows-x64    • Microsoft Windows [versÆo 10.0.26200.9168]
